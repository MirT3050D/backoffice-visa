...
<body>
    ...
    <div class="container">
        <div class="form-header">
            <h1>Duplicata termine</h1>
            <p class="progress-indicator">Visa et carte resident dupliquee</p>
        </div>
        ...
        <c:if test="${not empty carteResident}">
            <div class="result-card">
                <div class="result-title">Carte resident dupliquee</div>
                <div class="result-grid">
                    <div class="result-item">
                        <span>Numero carte</span>
                        <strong>${carteResident.num}</strong>
                    </div>
                    <div class="result-item">
                        <span>Visa associe</span>
            ...
            <div class="result-card">
                <div class="result-title">Details du visa</div>
                <div class="result-grid">
                    <div class="result-item">
        ...
        <div class="btn-group">
            <a class="btn btn-secondary" href="${pageContext.request.contextPath}/demande-visa/list">Retour</a>
        </div>
    </div>
